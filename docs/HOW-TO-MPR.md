...
The GroceryVision dataset has 12,944 front-facing images across 409 SKUs, roughly 31 images per product on average.
...
MobileCLIP-B achieves $\phi = 2.36$, the highest among models with Recall@1 > 65%. A 1.8B-parameter SigLIP2 model achieves only $\phi = 0.60$ despite higher absolute accuracy.
